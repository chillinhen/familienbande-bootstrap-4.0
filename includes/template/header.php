<header id="header">
    <div id="top-bar" class="col-12 mt-4">
        <div class="d-flex flex-lg-column flex-xs-row flex-xl-row justify-content-between align-items-center">
            ...
            <!-- align-self-center d-block d-md-none-->
            ...
            <button class="search btn btn-outline-success align-self-center order-md-2 order-lg-3 d-none d-xl-block" type="button" data-toggle="modal" data-target="#modalSearchDialog"><i class="fas fa-search"></i><span>Suche</span></button>
        </div>
    </div>
</header>
