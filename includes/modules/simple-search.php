<form class="form-inline">
    <fieldset class="ui-widget">
        ...
        <input id="search" type="search" class="form-control" placeholder="Stichwort eingeben ..." autocomplete="off">
        <button class="" type="submit"><i class="fas fa-search"></i><span>Suche</span></button>
    </fieldset>
