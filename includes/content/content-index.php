<section class="featured">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 ads d-none d-lg-block text-center"><img src="img/google-ads-landscape.jpg" alt=""/></div>
    </div>
</section>
<section class="main-content">
    <div class="row">
        ...
        <div class="col-lg-8 content order-lg-1">
            ...
            <div class="ads d-none d-sm-block my-5">
                <img class="img-fluid" src="img/google-ads-dummy.jpg" alt=""/>
            </div>
...
<section class="bottom">
    <div class="row d-none d-sm-block my-5">
        <div class="col-12">
